  ...
  const handleEnable = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        // Salva il flag che il permesso è stato concesso
        localStorage.setItem('notificheAsked', '1')
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        ...
        <button
          onClick={() => {
            // Salva il flag che è stato chiesto, così non lo chiediamo più fino a quando il permesso non cambia
            localStorage.setItem('notificheAsked', '1')
            onClose()
          }}
          disabled={loading}
